  ...
  <div v-else class="min-h-screen bg-[#f8fafc]">
    <header class="mb-8 flex justify-between items-end">
      ...
      <div class="text-right">
        <button
          class="bg-[#4C4CDD] text-white px-4 py-2 rounded font-bold text-sm 0 hover:bg-[#4c4cddc9] transition-all mb-2"
      ...
      <div class="lg:col-span-12 bg-white p-6 rounded-2xl border border-slate-200">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-center border-collapse">
            <thead>
              <tr
                class="bg-slate-50 text-slate-500 text-[13px] font-bold border-y border-slate-100 uppercase tracking-wider">
            ...
            <tbody class="divide-y divide-slate-50 text-[13px]">
              <tr v-for="urgent in dashboardData.urgentOrders" :key="urgent.orderId"
                class="hover:bg-slate-50 cursor-pointer transition-colors" @click="goToDetail(urgent.orderId)">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-centerborder-collapse">
            ...
            <tbody class="divide-y divide-slate-50 text-center text-[13px]">
              <tr v-for="order in dashboardData.orderList" :key="order.orderId"
                class="hover:bg-slate-50 transition-colors" @click="goToDetail(order.orderId)">
                ...
                <td class="p-4 text-center">
                  <div class="flex items-baseline justify-center gap-2">
                    ...
                    <div v-if="order.totalItemCount > 1">
...
const goToNoticeDetail = (notice) => {
  router.push(`/client-portal/notices/${notice.id}`);
};
